      ...
      <ThemeProvider theme={theme}>
        <Container maxWidth="lg">
          ...
          <Grid container spacing={6}
            alignItems="center">
            <Grid item xs={12} lg={6}><form onSubmit={formik.handleSubmit}>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <TextField
                        ...
                        onChange={formik.handleChange}
                        error={
                          formik.touched.power1 && Boolean(formik.errors.power1)
                        }
                        helperText={
                    ...
                    <Grid item xs={12} sm={4}>
                      <TextField
                        ...
                        onChange={formik.handleChange}
                        error={
                          formik.touched.power2 && Boolean(formik.errors.power2)
                        }
                        helperText={
            ...
            {formik.submitCount > 0 && formik.isValid ?
              <Grid item xs={12} lg={6} >
                < Grid container className="priceSimulation">
                  <TariffSimulation values={formik.values} />
                </Grid>
              </Grid> : null}
          </Grid>
        </Container>
